...
PID_control::PID_control()
{
	...
	wheel_sub=n.subscribe("first_wheel",10,&PID_control::firstencoderCb,this);
	offsetSub=n.subscribe("offset",10,&PID_control::offsetCb,this);
	pos_desSub=n.subscribe("first_pos_des",10,&PID_control::desCb,this);
	
	ang_pub=n.advertise<std_msgs::Float32>("ang_first",20);
	vel_pub=n.advertise<std_msgs::Float32>("vel_first",20);
