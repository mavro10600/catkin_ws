...
PID_control::PID_control()
{
	...
	wheel_sub=n.subscribe("third_wheel",10,&PID_control::firstencoderCb,this);
	offsetSub=n.subscribe("offset",10,&PID_control::offsetCb,this);
	pos_desSub=n.subscribe("third_pos_des",10,&PID_control::desCb,this);
	
	ang_pub=n.advertise<std_msgs::Float32>("ang_third",20);
	vel_pub=n.advertise<std_msgs::Float32>("vel_third",20);
	out_pub=n.advertise<std_msgs::Int16>("third_wheel_speed",1);
