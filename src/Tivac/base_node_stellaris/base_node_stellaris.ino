...
{
  //roboclaw.ForwardBackwardM1(address,64);
  if(fl2_stat==true){if(flipper2_out<0){Serial2.write(128+flipper2_out);}else {Serial2.write(128+64);}}
  if(fl2_stat==false){if(flipper2_out>0){Serial2.write(128+64);}else {Serial2.write(128+flipper2_out);}}
}

if (endstp2==false)
Serial2.write(128+flipper2_out);
...
{
  //roboclaw.ForwardBackwardM1(address,64);
  if(fl4_stat==true){if(flipper4_out>0){Serial3.write(128+flipper4_out);}else {Serial3.write(128+64);}}
  if(fl4_stat==false){if(flipper4_out<0){Serial3.write(128+64);}else {Serial3.write(128+flipper4_out);}}
}

if (endstp4==false)
Serial3.write(128+flipper4_out);
